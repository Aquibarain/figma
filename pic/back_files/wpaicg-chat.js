...
function wpaicgChatInit() {
    ...
    function wpaicgSendChatMessage(chat, typing, type, blob) {
        ...
        console.log('voice_service', voice_service);
        ...
        console.log('openai_output_format', openai_output_format);
        let openai_voice_speed = chat.getAttribute('data-openai_voice_speed');
        console.log('openai_voice_speed', openai_voice_speed);
                ...
                if (wpaicg_response_text !== '' && wpaicg_message !== '') {
                    if(parseInt(wpaicg_speech) == 1){
                        if(voice_service === 'google'){
                            ...
                            console.log('wpaicg_voice', wpaicg_voice);
